...
[
    ["cop_base", 60, "(not(player call RPP_fnc_isCop))", "cop_exit", "You are not a cop and cannot enter this area."],
	["emt_base", 25, "(not(player call RPP_fnc_isemt))", "cop_exit1", "You are not a Doctor and cannot enter this area."]
];
