...
[
   /* Cop Vehicle Shop */
	[shop_policecar, "B_Hunter_F", "", [0,0], [] call RPP_fnc_generateID, 100, false, true],
	[shop_policecar2, "O_Galkin_F", "", [0,0], [] call RPP_fnc_generateID, 100, false, true],
	[shop_policecar3, "B_Hunter_RCWS_F", "", [0,0], [] call RPP_fnc_generateID, 100, false, true],
	[shop_policeheli, "B_MH9_F", "", [0,0], [] call RPP_fnc_generateID, 100, false, true],
	[shop_policeboat, "B_SpeedBoat", "", [0,0], [] call RPP_fnc_generateID, 100, false, true],
   ...
   /* Police Weapons */
    ...
    /* Car shop */
    [shop_civcar, "c_offroad", "", [0,0], [] call RPP_fnc_generateID, 6, true, true],
    [shop_civbike, "B_Quadbike_F", "", [0,0], [] call RPP_fnc_generateID, 6, true, true],
    [shop_civbike2, "O_Quadbike_F", "", [0,0], [] call RPP_fnc_generateID, 6, true, true],
	
	/* Boat shop */
    [shop_civboat, "O_Assaultboat", "", [0,0], [] call RPP_fnc_generateID, 5, true, false],
    [shop_civboat2, "O_Lifeboat", "", [0,0], [] call RPP_fnc_generateID, 5, true, false],
	
	/* South Airpot */
	[shop_civhelli, "O_Ka60_Unarmed_F", "", [0,0], [] call RPP_fnc_generateID, 3, true, false],
