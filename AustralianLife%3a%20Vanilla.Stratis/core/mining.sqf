...
[
    /* Mines */
	//TIER 1
	[ 0, [stone1], "Stone Mine", [ ["mining", 1], 2, 160, "Pickaxe", "Stone", 25, 1]],
	[ 1, [ironrock1], "Mine Iron", [ ["mining", 10], 4, 320, "Pickaxe", "IronOre", 25, 1]],
	[ 2, [salt1], "Mine Salt", [ ["mining", 1], 2, 160, "Pickaxe", "Salt", 25, 1]],
	[ 3, [sand1], "Dig Sand", [ ["mining", 1], 2, 160, "Shovel", "Sand", 30, 1]],	
	
	//TIER 2
	[ 4, [copperrock1], "Copper Iron", [ ["mining", 20], 5, 650, "Pickaxe", "CopperOre", 20, 1]],
	[ 5, [coal1], "Mine Coal", [ ["mining", 25], 8, 920, "Pickaxe", "Coal", 25, 1]],
	[ 6, [clay1], "Dig Clay", [ ["mining", 20], 5, 650, "Shovel", "Clay", 30, 1]],
	
	//TIER 3
	[ 8, [Sulphur1], "Sulpur Mine", [ ["mining", 40], 15, 250, "Pickaxe", "Sulphur", 20, 1]],
	[ 9, [oil1], "Pump Oil", [ ["mining", 30], 15, 1900, "Pump", "Oil", 18, 1]],
	
	//TIER 4
	[ 10, [Silver1], "Silver Mine", [ ["mining", 60], 18, 4200, "Shovel", "Silver", 18, 1]],
	[ 11, [goldrock1], "Gold Ore", [ ["mining", 85], 25, 8200, "Pickaxe", "GoldOre", 16, 1]],
	
	//TIER 5
   	[ 12, [Diamond1], "Diamond Mine", [ ["mining", 99], 40, 16400, "Pickaxe", "Diamond", 25, 1]]
...
RPP_fnc_mineResource = 
{
    ...
    if (_level < _reqSkill) exitWith /* Not high enough level */
    {
		...
		diag_log format ["Failed mining. Not enough skill. I have %1 and require %2.",_level,_reqskill];
    };
    ...
    if (_success) then
    {
        ...
        if (_roll <= _failChance) exitWith
        {
			...
			diag_log "Failed mining. I rolled a failure on line 163.";
        };
        ...
        if (not([_getRsc, 1] call RPP_fnc_addInventoryItem)) exitWith
        {
			...
			diag_log "Failed mining. I didn't have enough room to get the object on line 170.";
        };
...
{
    {
		...
		diag_log format ["Initializing mine %1",_x];
        ...
        {
            _obj = _x;
			diag_log format ["     Initializing mine item %1",_x];
