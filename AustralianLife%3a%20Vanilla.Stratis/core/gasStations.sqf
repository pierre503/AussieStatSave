...
{ 
    ...
    {
        _x setFuelCargo 0;
    } forEach (nearestObjects [_logic, ["FuelStation","Land_benzina_schnell", "Land_benzina_schnell", "Land_fuelstation", "Land_fuelstation_army"], 30]);
...
RPP_fnc_refuelVehicle = 
{
    ...
    {
        localize "STRS_gasStations_fullFuel" call RPP_fnc_hint;
        _ok = false;
    };
