...
[
	...
	//TIER 2
	[ 4, [copperrock1, copperrock2, copperrock3], "Copper Iron", [ ["mining", 20], 5, 650, "Pickaxe", "CopperOre", 20, 1]],
	[ 5, [coal1, coal2, coal3], "Mine Coal", [ ["mining", 25], 8, 920, "Pickaxe", "Coal", 25, 1]],
	[ 6, [clay1], "Dig Clay", [ ["mining", 20], 5, 650, "Shovel", "Clay", 30, 1]],
	
	//TIER 3
	[ 8, [sulphur1, sulpher2, sulpher3], "Sulpur Mine", [ ["mining", 40], 15, 250, "Pickaxe", "Sulphur", 20, 1]],
	[ 9, [oil1], "Pump Oil", [ ["mining", 30], 15, 1900, "Pump", "Oil", 18, 1]],
	
	//TIER 4
	[ 10, [silver1,silver2,silver3], "Silver Mine", [ ["mining", 60], 18, 4200, "Shovel", "Silver", 18, 1]],
	[ 11, [goldrock1], "Gold Ore", [ ["mining", 85], 25, 8200, "Pickaxe", "GoldOre", 16, 1]],
	
	//TIER 5
   	[ 12, [diamond1, diamond2, diamond3], "Diamond Mine", [ ["mining", 99], 40, 16400, "Pickaxe", "Diamond", 25, 1]]
];
