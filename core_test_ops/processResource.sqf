...
_RPP_var_processPine = [ ["pine_log", 6], ["wood", 3], ["pine_log", 4] ];
_RPP_var_processAlder = [ ["alder_log", 5], ["wood", 3], ["alder_log", 4] ];
_RPP_var_processLarix = [ ["larix_log", 4], ["wood", 3], ["larix_log", 3] ];
_RPP_var_processMaple = [ ["maple_log", 4], ["wood", 4], ["maple_log", 3] ];
_RPP_var_processRubber = [ ["rubber_log", 2], ["Rubber", 4], ["Rubber", 2] ];
_RPP_var_processSand = [ ["Sand", 2], ["Glass", 1], ["Sand", 1] ];				
_RPP_var_processClay = [ ["Clay", 2], ["Bricks", 1], ["Sand", 2] ];				
_RPP_var_processOil = [ ["Oil", 5], ["Petrol", 10], ["Petrol", 5] ];
_RPP_var_processBottles = [ ["Bottle", 1], ["High_bottleWater", 1], ["Low_bottleWater", 1] ];
_RPP_var_processSand2 = [ ["Sand", 10], ["Silicon", 1], ["Sand", 2] ];
...
[
	...
	[process_Iron1, "Smelt Iron Ore", "Process", _RPP_var_smeltIron, ["manufacture", 20, 500, 420], 25],	
	[process_gold, "Smelt Copper Ore", "Process", _RPP_var_smeltGold, ["manufacture", 20, 500, 420], 25],
	[process_silver, "Smelt Copper Ore", "Process", _RPP_var_smeltSilver, ["manufacture", 20, 500, 420], 25],
	[process_Populus, "Smelt Copper Ore", "Process", _RPP_var_processPopulus, ["manufacture", 20, 500, 420], 25],
	[process_Pine, "Smelt Copper Ore", "Process", _RPP_var_processPine, ["manufacture", 20, 500, 420], 25]
];
