...
[] spawn
{
    ...
    while {true} do
    {
        ...
        ((RPP_display_ui select 0) displayCtrl 1) ctrlSetStructuredText parseText format["<t color='#4876FF'>Money: $%1 / Bank: $%8 - Inventory Size: %2/%3 - Health: %4/100 - Hunger: %6 - Thirst: %7</t>", _money, _weight, _maxWeight, _health, _id, _hunger, _thirst, _bankMoney];
        sleep 1;
    };
};