...
[
    [license_car, "car", 2000],
	[license_ins, "ins", 1500]
];
...
{
    {
        ...
        _text = format["<t size='0.55' color='#008000'>%1</t><br/><t size='0.45'>$%2</t><br/><t size='0.4'>(Press F to buy)<br/></t><t size='0.4'></t>", _name, _price];
        _onKeyAccess = "";
