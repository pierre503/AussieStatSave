...
RPP_var_gasStations = [ [gas1, "Arar Fuel"], [gas2, "Schnell Fuel"], [gas3, "Oxygen Fuel"], [gas4, "Schnell Fuel"], [gas5, "Schnell Fuel"], [gas6, "Schnell Fuel"], [gas7, "Schnell Fuel"], [gas8, "Schnell Fuel"]   ];
{ 
    _logic = (_x select 0);
